 ...
 */
class accessorybox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "accessory@accessory";
    public $boxlabel;
    public $depends = array("accessory");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/accessory/class/accessory.class.php";
